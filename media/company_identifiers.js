/* ============================================================
   Full Bluetooth SIG company-identifier registry
   for the GHOSTTOOTH scanner (loaded before script.js as a classic script).

   COMPANY_IDENTIFIERS maps a numeric Bluetooth company ID to its
   registered company name (~4,300 entries).
...
/** Map of numeric Bluetooth company ID -> registered company name. */
const COMPANY_IDENTIFIERS = new Map([
    [0x10E1, "Neurable, Inc"],
