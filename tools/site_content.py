    ...
    "langs": {
        "en": {
            ...
            "blocks": [
                ...
                {"type": "p", "text": "Need a different country or a different kind of help? <a href=\"https://help.labidi.eu/\" rel=\"noopener\" target=\"_blank\"><strong>Oasis Online</strong></a>, our directory of official helplines, lists verified numbers for over 230 countries and territories, searchable by situation, with one-tap calling."},
        ...
        "fr": {
            ...
            "blocks": [
                ...
                {"type": "p", "text": "Un autre pays, ou un autre type d'aide ? <a href=\"https://help.labidi.eu/\" rel=\"noopener\" target=\"_blank\"><strong>Oasis Online</strong></a>, notre annuaire de lignes d'aide officielles, répertorie des numéros vérifiés pour plus de 230 pays et territoires, par situation, avec appel en un geste."},
        ...
        "nl": {
            ...
            "blocks": [
                ...
                {"type": "p", "text": "Een ander land, of een ander soort hulp nodig? <a href=\"https://help.labidi.eu/\" rel=\"noopener\" target=\"_blank\"><strong>Oasis Online</strong></a>, onze gids met officiële hulplijnen, bevat geverifieerde nummers voor ruim 230 landen en gebieden, doorzoekbaar op situatie, met bellen in één tik."},
        ...
        "fr": {
            ...
            "blocks": [
                ...
                {"type": "ul", "items": [
                    ...
                    "<strong>Le nom prouve un pont série, jamais un délit.</strong> La radio dit seulement « voici un module Bluetooth-série générique qui porte encore son nom d'usine ». Elle ne dit rien de ce qui est câblé de l'autre côté.",
                    "<strong>Bluetana a rencontré la même limite.</strong> L'étude note que des équipements industriels et de gestion de flotte parfaitement légitimes portent ces mêmes noms par défaut et « ressembleraient exactement à des skimmers ».",
                    "<strong>D'où le niveau « possible ».</strong> L'appareil apparaît dans votre liste avec son explication, mais il n'est <em>pas</em> compté dans le total de surveillance en haut de l'écran et ne déclenchera <strong>jamais</strong> d'alerte à lui seul.",
                ]},
        ...
        "nl": {
            ...
            "blocks": [
                ...
                {"type": "ul", "items": [
                    ...
                    "<strong>De naam bewijst een seri\u00eble brug, nooit een misdrijf.</strong> De radio zegt alleen \u201cdit is een generieke bluetooth-naar-serieel-module die nog zijn fabrieksnaam draagt\u201d. Over wat er aan de andere kant vastzit, zegt hij niets.",
                    "<strong>Bluetana liep tegen dezelfde grens aan.</strong> Het onderzoek merkt op dat legitieme industri\u00eble en wagenparkapparatuur exact dezelfde standaardnamen draagt en \u201cer precies zo uitziet als een skimmer\u201d.",
                    "<strong>Vandaar het niveau \u2018mogelijk\u2019.</strong> Het apparaat verschijnt met uitleg in je lijst, maar telt <em>niet</em> mee in het surveillancetotaal bovenaan en geeft op zichzelf <strong>nooit</strong> een melding.",
                ]},
    ...
    "langs": {
        "fr": {
            ...
            "blocks": [
                ...
                {"type": "h2", "text": "3. Les définitions de détection"},
                {"type": "p", "text": "GhostTooth reconnaît les appareils en comparant ce qu'ils diffusent à ses <strong>définitions de détection</strong> : des listes tenues à jour qui disent quels appareils sont des <strong>traceurs</strong>, lesquels sont du <strong>matériel de surveillance</strong> (lunettes à caméra, enregistreurs) et lesquels sont des <strong>appareils ordinaires</strong> (écouteurs, montres, téléviseurs). Comme de nouveaux appareils sortent sans cesse, nous mettons ces listes à jour régulièrement et l'application les télécharge depuis <code>ghosttooth.labidi.eu</code>. La requête ne contient aucune donnée personnelle ni aucun résultat d'analyse, et nous n'en tirons ni profil ni recoupement. Chaque téléchargement est vérifié par somme de contrôle avant d'être utilisé."},
        ...
        "nl": {
            ...
            "blocks": [
                ...
                {"type": "h2", "text": "3. Detectiedefinities"},
                {"type": "p", "text": "GhostTooth herkent apparaten door wat ze uitzenden te vergelijken met zijn <strong>detectiedefinities</strong>: actueel gehouden lijsten die zeggen welke apparaten <strong>trackers</strong> zijn, welke <strong>surveillanceapparatuur</strong> (camerabrillen, recorders) en welke <strong>gewone apparaten</strong> (oordopjes, horloges, tv's). Omdat er voortdurend nieuwe apparaten verschijnen, werken we die lijsten regelmatig bij en downloadt de app ze van <code>ghosttooth.labidi.eu</code>. Dat verzoek bevat geen persoonsgegevens en geen scanresultaten, en we bouwen er geen profiel mee op. Elke download wordt eerst met een controlesom geverifieerd."},
